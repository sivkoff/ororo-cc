...
This script makes possible to show subtitles only when a video is paused.
...
Then add the script using the following link: https://github.com/sivkoff/ororo-cc/raw/master/main.user.js
